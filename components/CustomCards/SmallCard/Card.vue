...
<template>
  ...
  >
    ...
    <div
      class="w-full max-w-[180px] md:max-w-[200px] mx-auto overflow-hidden rounded-md"
    >
      <img
    ...
    <div class="mt-4 flex flex-col flex-1 items-center text-center">
      ...
      <div
        class="flex flex-wrap justify-center gap-1 text-sm text-blue-600 dark:text-blue-300 mt-1"
      >
        <span v-for="(platform, index) in content.platforms" :key="index">{{
          platform
        }}</span>
      </div>
      ...
      <div
        ...
        class="text-green-600 dark:text-green-400 font-medium mt-2"
      >
      ...
      <div class="mt-auto w-full">
        <span
          class="text-sm text-gray-700 dark:text-gray-300 font-medium block mt-4"
        >
          Cómpralo en:
        </span>
