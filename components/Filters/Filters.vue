...
watch(hasHaptic, (newVal) => emit("update:hasHaptic", newVal));
</script>

<template>
  <div class="sticky top-0 z-20">
    <div class="flex flex-col items-center bg-gray-800 py-4 mb-8">
      <div class="flex gap-y-4 md:justify-around px-4 gap-x-4 mt-4">
        <div>
        ...
        <div>
          ...
          />
          <div
            class="toggle-label w-12 h-6 rounded-full relative cursor-pointer transition-colors mt-2"
