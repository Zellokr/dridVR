...
<template>
  <div class="flex flex-col justify-center items-center bg-gray-900 py-4 md:px-0 lg:px-0">
    <h1 class="text-white text-4xl md:text-5xl lg:text-5xl xl:text-5xl font-bold py-4 px-4">Todos los juegos</h1>
